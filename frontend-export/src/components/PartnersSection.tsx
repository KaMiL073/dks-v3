...
export default function PartnersSection({
  title = "Our partners",
  description = "We build our strong and stable position in the office and printing equipment market through close cooperation with the world's leading manufacturers and brands.",
  ...
  return (
    <section className="px-6 md:px-28 py-12 md:py-20 bg-surface-page flex flex-col gap-12">
      <Heading2 variant="semibold">{title}</Heading2>
