  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={`${styles.field} ${styles.full}`}>
        <label htmlFor="monoCounter">Licznik mono:</label>
        <input
          {...register('monoCounter')}
          // placeholder="Licznik mono"
          id={`${formName}_monoCounter`}
          name="monoCounter"
          type="text"
          autoComplete="monoCounter"
          required
        />
      </div>

      <div className={`${styles.field} ${styles.full}`}>
        <label htmlFor="colorCounter">Licznik kolor:</label>
        <input
          {...register('colorCounter')}
          // placeholder="Licznik kolor"
          id={`${formName}_colorCounter`}
          name="colorCounter"
          type="text"
          autoComplete="colorCounter"
          required
        />
      </div>

      <div className={`${styles.field} ${styles.full}`}>
        <label htmlFor="tbcCounter">Licznik TBC:</label>
        <input
          {...register('tbcCounter')}
          // placeholder="Licznik TBC"
          id={`${formName}_tbcCounter`}
          name="tbcCounter"
          type="text"
          autoComplete="tbcCounter"
          required
        />
      </div>

      <div className={`${styles.field} ${styles.full}`}>
        <label htmlFor="message">Szczegóły zamówienia:</label>
        <textarea
          {...register('message')}
          // placeholder="Szczegóły zamówienia"
          className="h-40"
      ...
      <div className={`${styles.field} ${styles.full} ${styles.checkbox}`}>
        ...
        <label htmlFor="clause_for_answers">
          ...
          w celu udzielenia odpowiedzi na zgłoszenie oraz wystawienia dokumentów rozliczeniowych 
          przez DKS Sp. z o.o. Zgoda jest dobrowolna i w każdym dowolnym momencie można z niej zrezygnować. 
      ...
      <div className={`${styles.field} ${styles.full} ${styles.checkbox}`}>
        ...
        <label htmlFor="clause">
          Wyrażam zgodę na przetwarzanie moich danych podanych 
          w powyższym formularzu przez DKS Sp. z o.o., 
          zgodnie z przepisami rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 
          ...
          Zgoda jest dobrowolna i w każdym dowolnym momencie można 
          z niej zrezygnować. Żądanie usunięcia danych proszę kierować 
          na adres rodo@dks.pl. 
          Cofnięcie zgody na przetwarzanie danych nie 
