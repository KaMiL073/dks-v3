...
export default function DebtCollectionForm() {
  const formName = 'DebtCollectionForm';
    ...
    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={`${styles.field} ${styles.full} ${styles.checkbox}`}>
        ...
        <label htmlFor="clause_for_answers">
          ...
          Dz. Urz. UE z 4.5.2016 r. L 119, str. 1, w celu udzielenia odpowiedzi 
          na złożone zapytanie. 
      ...
      <div className={`${styles.field} ${styles.full} ${styles.checkbox}`}>
        ...
        <label htmlFor="clause">
          ...
          w celu otrzymywania od DKS Sp. z o.o. treści marketingowych 
          oraz informacji handlowych, w tym informacji o promocjach i ofertach, 
      ...
      <div className="text-tiny leading-3 mb-6">
        ...
        <p>
          Więcej informacji o tym, jak przetwarzamy Twoje dane znajdziesz w <Link href="/klauzula-ochrony-danych-data-protection">
