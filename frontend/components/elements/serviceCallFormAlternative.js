...
export default function ServiceCallFormCLientZone() {
  const formName = 'ServiceCallFormClientZone';
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={styles.field}>
        <label htmlFor="serialNumber">Numer seryjny / Numer urządzenia:</label>
        <input
