// frontend-new/src/app/(marketing)/AboutSection.tsx
      ...
      <RichContentStatic
        ...
        content={`
          <div class="flex-1 text-Text-body text-base font-normal leading-tight">
            ...
            Dostarczamy drukarki i <span class="underline">urządzenia wielofunkcyjne do biura</span>, kserokopiarki, skanery i niszczarki.
            ...
            Dostarczamy drukarki i <span class="underline">sprzęt poligraficzny</span> dla drukarń cyfrowych.
            ...
            Sprzedajemy m.in. skanery Contex, plotery tonerowe KIP, <span class="underline">składarki offline</span> es-te, plotery atramentowe Océ, OKI, Canon, Konica Minolta.
          </div>
        `}
        expanded_columns={2}
