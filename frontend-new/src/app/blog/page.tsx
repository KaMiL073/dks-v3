...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "pl_PL",
    type: "website",
    images: [{ url: "/og/blog.jpg", width: 1200, height: 630, alt: "Blog DKS – wiedza o druku i technologii" }],
  },
  twitter: {
            ...
            {posts.map((post) => (
              ...
              >
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-Text-body text-base leading-5 line-clamp-4">{post.lead}</p>
                </div>
              </a>
            ))}
          </div>
